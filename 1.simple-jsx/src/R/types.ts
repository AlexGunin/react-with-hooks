...
export type ElementProps<Type extends ElementType> = Type extends CustomElementType ? TextElementProps : Type extends  HTMLElementType ? HTMLElementTagNameMap[Type] : {}
